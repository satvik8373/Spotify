export const AUDIO_QUALITY_ORDER = ['320kbps', '160kbps', '96kbps', '48kbps', '12kbps'];

export const getHighestQualityDownload = (downloadUrl) => {
...
export const getHighestQualityAudioUrl = (downloadUrl) => {
