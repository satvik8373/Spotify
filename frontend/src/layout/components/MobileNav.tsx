...
const MobileNav = () => {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-30 bg-gradient-to-t from-black to-black/90 border-t border-rose-950/30 md:hidden"
      style={{
        ...
        {navItems.map(item => (
          ...
          >
            <item.icon className={cn(
              'h-5 w-5 mb-1', 
              isActive(item.path) && 'text-rose-500'
            )} />
