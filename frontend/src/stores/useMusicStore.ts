	...
	fetchIndianTrendingSongs: async () => {
		...
		try {
			...
			try {
				...
				response = await fetch('https://saavn.dev/api/search/songs?query=latest%20hits&page=1&limit=10');
	...
	fetchBollywoodSongs: async () => {
		...
		try {
			...
			try {
				...
				// Fallback to direct API
				console.log('Trying direct JioSaavn API...');
				response = await fetch('https://saavn.dev/api/search/songs?query=bollywood%20hits&page=1&limit=15');
	...
	fetchHollywoodSongs: async () => {
		...
		try {
			...
			try {
				...
				// Fallback to direct API
				console.log('Trying direct JioSaavn API...');
				response = await fetch('https://saavn.dev/api/search/songs?query=english%20top%20hits&page=1&limit=15');
	...
	fetchOfficialTrendingSongs: async () => {
		...
		try {
			...
			try {
				...
				// Fallback to direct API
				console.log('Trying direct JioSaavn API...');
				response = await fetch('https://saavn.dev/api/search/songs?query=trending%20songs&page=1&limit=15');
				if (!response.ok) throw new Error('Failed to fetch trending songs');
				data = await response.json();
			}
	...
	fetchHindiSongs: async () => {
		...
		try {
			...
			try {
				...
				// Fallback to direct API
				console.log('Trying direct JioSaavn API...');
				response = await fetch('https://saavn.dev/api/search/songs?query=hindi%20top%20songs&page=1&limit=15');
	...
	fetchIndianNewReleases: async () => {
		...
		try {
			...
			try {
				...
				// Fallback to direct API
				console.log('Trying direct JioSaavn API...');
				response = await fetch('https://saavn.dev/api/search/songs?query=new%20releases&page=1&limit=10');
	...
	searchIndianSongs: async (query) => {
		...
		try {
			...
			try {
				...
				// Fallback to direct API
				console.log('Trying direct JioSaavn API...');
				response = await fetch(`https://saavn.dev/api/search/songs?query=${encodeURIComponent(query)}&page=1&limit=20`);
